...
public class TerrainGeneration {
	...
	private static void BuildChunk(object obj) {
		...
		try {
			...
			byte[,] oreNoiseMap = NoiseGenerator.GenerateOreNoiseMap(WorldAssets.ChunkLength, WorldAssets.ChunkHeight, WorldData.Singleton.Seed, WorldData.Singleton.OreScale, WorldData.Singleton.OreOctives, WorldData.Singleton.OrePersistance, WorldData.Singleton.OreLacurinarity, new Vector2(WorldData.Singleton.OreOffsetX + position.x * WorldAssets.ChunkLength, WorldData.Singleton.OreOffsetY + position.y * WorldAssets.ChunkHeight), bioms);
