...
public class SkeletonBrain : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (distanceToPlayer > lineOfMove && distanceToPlayer < lineOfSite)
        {
            ...
            if (ClientTerrainHandler.Singleton.GetBlockFormCoordinate(
    ...
    public void Attack()
    {
        if (attackAllowed)
        {
            ...
            DestroyGameObjectInSeconds(arrow, 10);
    ...
    public void DestroyGameObjectInSeconds(GameObject g, float s) {
        //after cd
